...
const students = [
  ...
  { name: "Abdul Kerim Kurt", class: "11 MF" }, { name: "Adem Tunahan Düzgün", class: "11 TM" },
  { name: "Ahmet Selim Baloğlu", class: "11 TM" }, { name: "Ahmet Sevban Çalı", class: "11 TM" },
  { name: "Bayram Salih Durmaz", class: "11 MF" }, { name: "Cafer Furkan Yıldırım", class: "11 MF" },
  { name: "Faruk Selman Sekmen", class: "11 TM" }, { name: "Hilmi Metin Kayır", class: "11 MF" },
  ...
  { name: "Mehmedhan Demirel", class: "10" }, { name: "Mehmet Çitil", class: "10" },
  { name: "Mehmet Eymen Kök", class: "10" }, { name: "Ömer Faruk Aydın", class: "10" },
  { name: "Rüçhan Arif Bağcı", class: "10" }, { name: "Yasin Talha Gömeç", class: "10" },
